...
module.exports = {
  ...
  mergeAllArrays: mergeWithCustomizers(customizers.mergeAllArrays),
  mergeWithArrays: (...keys) => mergeWithCustomizers(customizers.mergeWithArrays(...keys)),
