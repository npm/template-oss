...
var require_cjs = __commonJS({
  "node_modules/minimatch/dist/cjs/index.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.Minimatch = exports2.match = exports2.makeRe = exports2.braceExpand = exports2.defaults = exports2.filter = exports2.GLOBSTAR = exports2.sep = exports2.minimatch = void 0;
    ...
    var Minimatch = class {
      ...
      makeRe() {
        ...
        let re = set.map((pattern) => {
          const pp = pattern.map((p) => typeof p === "string" ? regExpEscape(p) : p === exports2.GLOBSTAR ? exports2.GLOBSTAR : p._src);
          pp.forEach((p, i) => {
            const next = pp[i + 1];
            const prev = pp[i - 1];
...
var require_index_cjs = __commonJS({
  "node_modules/minimatch/dist/cjs/index-cjs.js"(exports2, module2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
var require_lib4 = __commonJS({
  "node_modules/npm-normalize-package-bin/lib/index.js"(exports2, module2) {
    var { join: join2, basename } = require("path");
    ...
    var normalizeObject = (pkg) => {
      ...
      Object.keys(orig).forEach((binKey) => {
        const base = join2("/", basename(binKey.replace(/\\|:/g, "/"))).slice(1);
...
var require_lib5 = __commonJS({
  "node_modules/read-package-json-fast/lib/index.js"(exports2, module2) {
    ...
    var parse2 = require_lib3();
    var normalizePackageBin = require_lib4();
    var { resolve, dirname, join: join2, relative: relative2 } = require("path");
    var rpj = (path) => readFile(path, "utf8").then((data) => readBinDir(path, normalize(stripUnderscores(parse2(data))))).catch((er) => {
      er.path = path;
      throw er;
    });
...
var require_lib6 = __commonJS({
  "node_modules/@npmcli/map-workspaces/lib/index.js"(exports2, module2) {
    ...
    var minimatch = require_index_cjs();
    var rpj = require_lib5();
...
// <stdin>
var { join, relative } = require("path");
var core = require_core();
var mapWorkspaces = require_lib6();
var wsFlags = ({ root, workspaces }) => {
  return [root ? "-iwr" : "", ...workspaces.map((ws) => `-w="${ws.name}"`)].join(" ").trim();
};
var main = async ({ cwd, files: files2, all: all2 }) => {
  ...
  const changedWorkspaces = /* @__PURE__ */ new Set();
...
var arg = core.getInput("files");
var all = arg === "--all";
var files = all ? [] : JSON.parse(arg || "[]");
module.exports = main({
  cwd: process.env.GITHUB_WORKSPACE,
  files,
  all
}).then((r) => core.setOutput("flags", r)).catch((err) => {
